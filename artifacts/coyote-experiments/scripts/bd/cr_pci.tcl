...
########################################################################################################
  ...
  # External reset
  # set cmd "connect_bd_net \[get_bd_pins clk_wiz_0/reset]"
  ...
  # append cmd " \[get_bd_pins proc_sys_reset_href/ext_reset_in]"
  ...
  # connect_bd_net -net href_aresetn_1 [get_bd_ports hrefresetn] [get_bd_pins proc_sys_reset_href/peripheral_aresetn]
  # connect_bd_net -net clk_wiz_0_clk_out6 [get_bd_ports hrefclk] [get_bd_pins clk_wiz_0/clk_out6] [get_bd_pins proc_sys_reset_href/slowest_sync_clk]
