...
create_ip -name vio -vendor xilinx.com -library ip -version 3.0 -module_name vio_shell
set cmd "set_property -dict \[list CONFIG.C_PROBE_IN0_WIDTH {$cfg(n_reg)} CONFIG.C_NUM_PROBE_OUT {0} CONFIG.C_NUM_PROBE_IN {1}] \[get_ips vio_shell]"
eval $cmd
